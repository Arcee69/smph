...
const Header = () => {
  return (
    <div className='flex items-center justify-between w-full bg-WHITE-_100 mt-2 mb-5 '>
        ...
        <div className='flex w-full gap-[130px] '>
            {/* <div className='flex  w-[200px] py-[15px] px-[80px] border border-y-0 border-solid border-[#8D3203] border-r-0'>
             <a href='' >Home</a>
            </div> */}
            <div className='flex items-center justify-center  w-[100px] border border-l-0 border-t-0 border-b-[#fff] border-solid border-r-0 hover:border-b-[#3D1601] '> {/*  w-[200px] py-[15px] px-[80px] */}
             <a href='' >Services</a>
            </div>
            <div className='flex items-center justify-center  w-[100px] border border-l-0 border-t-0 border-b-[#fff] border-solid border-r-0 hover:border-b-[#3D1601] '> {/*  w-[200px] py-[15px] px-[80px] */}
             <a href='' >Portfolio</a>
